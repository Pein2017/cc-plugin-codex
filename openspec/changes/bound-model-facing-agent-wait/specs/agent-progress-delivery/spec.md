...
#### Scenario: Later revisions follow an earlier delivery
- **WHEN** an active job has already delivered one progress update and later publishes tool, hook, thinking, responding, retrying, or reconnecting revisions
- **THEN** those revisions do not become model-facing progress during that job and wait continues toward completion or timeout
